...
public class DateTextField extends JTextField {
    ...
    // create a new JDialog where the date panel will be shown
    ...
    private void addListeners() {
        addMouseListener(new MouseAdapter() {
            public void mouseClicked(MouseEvent paramMouseEvent) {
                // initializes a DatePanel if the datePanel is null
                if (datePanel == null) {
                    datePanel = new DatePanel();
                }
                // this point refers to the point where the DatePanel will be displayed
                Point point = getLocationOnScreen();
                point.y = point.y + 30;
                // call function to show Date Dialog
    ...
    private void showDateDialog(DatePanel dateChooser, Point position) {
        // get's the frame that the DateTextField component is placed in
        ...
        // sets the location of the dialog based on some calculation that I do not understand
    ...
    private JDialog createDateDialog(JDialog owner, JPanel contentPanel) {
        // create a dialog where the Date picker will be shown
    ...
    // calculation to get the position of the dialog
    // I changed the owner parameter from a frame to a dialog because of the app I was using
    private Point getAppropriateLocation(JDialog owner, Point position) {
        Point result = new Point(position);
        // get the top-left point of the parent frame
        Point p = owner.getLocation();
        // offset: a distance measured fromm a particular position
    ...
    // get the date formatter that will be used to format dates given to it
    ...
    // set the text in textfield
    public void setText(Date date) {
        setDate(date);
    }

    public void setDate(Date date) {
        // this will use the date given and parse it into text
        super.setText(getDefaultDateFormat().format(date));
    }

    public Date getDate() {
        try {
            // return a date from the textfield's value
    ...
    private class DatePanel extends JPanel implements ChangeListener {
        ...
        JSpinner yearSpin;
        JSpinner monthSpin;
        // create a 6-week by 7-day calendar grid
        ...
        DatePanel() {
            ...
            // panel that will show selected month and year
            JPanel topYearAndMonth = createYearAndMonthPanal();
            add(topYearAndMonth, BorderLayout.NORTH);
            // panel that will show all available days in the month
        ...
        private JPanel createYearAndMonthPanal() {
            ...
            // the calendar object normally starts counting from zerox
